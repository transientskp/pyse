...
def make_measurements_dataframe(
    ...
    columns = {
        ...
        SourceParams.RA_ERR: ra_errors,
        SourceParams.DEC: sky_barycenters[:, 1],
        SourceParams.DEC_ERR: dec_errors,
        ...
        SourceParams.THETA_CELES_ERR: theta_celes_errors,
        SourceParams.THETA_DC_CELES: theta_dc_celes_values,
        SourceParams.THETA_DC_CELES_ERR: theta_dc_celes_errors,
